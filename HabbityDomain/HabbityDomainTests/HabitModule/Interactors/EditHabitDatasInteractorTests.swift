...
final class EditHabitDatasInteractorTests: XCTestCase {
    ...
    func test_addHabitData_incorrectValue_dataWasNotAdded() {
        let habit = Habit(id: UUID(), habitTitle: "", timePeriod: .day, habitDataType: .boolean, habitDatas: [])
    ...
    func test_addHabitData_correctValue_dataWasAdded() {
        let habit = Habit(id: UUID(), habitTitle: "", timePeriod: .day, habitDataType: .range, habitDatas: [])
        let sut = makeSUT(habit: habit)
    ...
    func test_isHabitContainHabitData_correct() {
        let habitData = HabitData(id: UUID(), value: 3, date: Date())
        let habit = Habit(id: UUID(), habitTitle: "", timePeriod: .day, habitDataType: .range, habitDatas: [habitData])
        let sut = makeSUT(habit: habit)
    ...
    func test_updateHabitData_correctValue_valueWasChanged() {
        ...
        let habit = Habit(id: UUID(), habitTitle: "", timePeriod: .day, habitDataType: .range, habitDatas: [habitData1, habitData2, habitData3])
        let sut = makeSUT(habit: habit)
