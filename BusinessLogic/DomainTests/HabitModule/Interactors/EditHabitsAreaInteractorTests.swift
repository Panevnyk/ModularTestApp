...
final class EditHabitsAreaInteractorTests: XCTestCase {
    ...
    func test_createQuestionPoolOutput_withOneQuestion_poolCreatedSuccessfuly() {
        ...
        sut.addHabit(Habit(id: UUID(), habitTitle: "", timePeriod: .day, habitDataType: .boolean, habitDatas: []))
        sut.saveHabitsArea()
    ...
    func test_createQuestionPoolDB_withTwoQuestions_poolCreatedSuccessfuly() {
        ...
        sut.addHabit(Habit(id: UUID(), habitTitle: "Test1", timePeriod: .day, habitDataType: .boolean, habitDatas: []))
        sut.addHabit(Habit(id: UUID(), habitTitle: "Test2", timePeriod: .day, habitDataType: .range, habitDatas: []))
        sut.saveHabitsArea()
